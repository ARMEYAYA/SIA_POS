...
const TRANSACTIONS = [
  { id: 'TXN-100245', customer: 'Hanni Pham', method: 'Union Bank - Card', ref: 'UB-REF-772001', total: 20000, status: 'reserved', date: new Date('2026-03-03T08:10:00') },
  { id: 'TXN-100246', customer: 'Mark Lee',    method: 'Union Bank - Card', ref: 'UB-REF-772002', total: 20000, status: 'reserved', date: new Date('2026-03-03T09:00:00') },
  { id: 'TXN-100247', customer: 'Angel Vargas',    method: 'Cash',              ref: 'UB-REF-772003', total: 20000, status: 'reserved', date: new Date('2026-03-03T09:30:00') },
  { id: 'TXN-100248', customer: 'Leah Jimenez',   method: 'Union Bank - Card', ref: 'UB-REF-772004', total: 20000, status: 'reserved', date: new Date('2026-03-03T10:15:00') },
  { id: 'TXN-100249', customer: 'Sam Ramos',      method: 'Union Bank - Card', ref: 'UB-REF-772005', total: 20000, status: 'reserved', date: new Date('2026-03-03T11:00:00') },
  { id: 'TXN-100250', customer: 'Nicole Cruz',    method: 'Union Bank - Card', ref: 'UB-REF-772006', total: 20000, status: 'reserved', date: new Date('2026-03-03T11:45:00') },
];
  ...
  return (
    <div className="dashboard">
      ...
      <div className="dashboard__stats fade-in">
        <StatCard value={120} label="Total Order" />
        <StatCard value={40}  label="To Shipped" />
        <StatCard value={5}   label="Overdue Order" />
      </div>
            ...
            {TOP_PRODUCTS.map((p) => (
              <div key={p.rank} className="top-product__item">
                ...
                <div className="top-product__info">
                  ...
                  <p className="top-product__units"><span>Units Sold:</span> {p.unitsSold}</p>
                  <p className="top-product__revenue"><span>Sales Revenue:</span> {p.revenue}</p>
                </div>
              ...
              <table className="txn__table">
                ...
                <tbody>
                  {sortedTxns.map((txn, i) => {
                    ...
                    return (
                      <tr key={txn.id} className="txn__row" style={{ animationDelay: `${i * 0.05}s` }}>
