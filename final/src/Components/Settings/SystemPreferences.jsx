                            ...
                            <div className='category-list'>
                                ...
                                <div className='category-top'>
                                    ...
                                    <button onClick={() => handleEditSave("category")}>
                                        {isCategoryEditing ? "Save" : <><img src={edit} />Edit</>}
                                    </button>
                                </div>
                            ...
                            <div className='size-list'>
                                <div className='size-header'>
                                    ...
                                    <button onClick={() => handleEditSave("size")}>
                                        {isSizeEditing ? "Save" : <><img src={edit} />Edit</>}
                                    </button>
                                </div>
                            ...
                            <div className='set-list'>
                                <div className='set-header'>
                                    ...
                                    <button onClick={() => handleEditSave("set")}>
                                        {isSetEditing ? "Save" : <><img src={edit} />Edit</>}
                                    </button>
                                </div>
                                            ...
                                            {setList.map((item, index) => (
                                                <li key={index}>
                                                    {isSetEditing ? (
                                                        <input
                                                            value={item}
                                                            onChange={(e) => handleChangeSet(index, e.target.value)}
                                                        />
                                                    ) : (
                                                        item
                                                    )}
